...
func NewAsset(buffer bytes.Buffer, info *FileAsset, writePath string, pipeline *Pipeline, mimeType string) *Asset {
	return &Asset{Buffer: buffer, Info: info, WritePath: writePath, Pipeline: pipeline, mimeType: mimeType}
}
